...
var Ripple = React7.memo(React7.forwardRef(function(inProps, ref) {
  var _React$useState = React7.useState(false), _React$useState2 = _slicedToArray4(_React$useState, 2), isMounted = _React$useState2[0], setMounted = _React$useState2[1];
  ...
  return React7.createElement("span", _extends3({
    role: "presentation",
    ref: inkRef
  }, rootProps, {
    onAnimationEnd
...
//# sourceMappingURL=chunk-A2JHG2YF.js.map
